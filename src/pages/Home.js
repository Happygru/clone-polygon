...
const Home = () => {
  ...
  const priceTypeTemplate = (option) => {
    return <span><i className={option.icon}></i> {option.text}</span>
  }
  ...
  const data = {
    ...
    forexAPI: {
      ...
      data: [
        ...
        { text: 'Real-time Currency Conversion', value: 'GET', type: 'success' },
        { text: 'Last Quote for a Currency Pair', value: 'GET', type: 'success' },
    ...
    cryptoAPI: {
      ...
      data: [
        ...
        { text: 'Snapshot - All Tickers', value: 'GET', type: 'success' },
        { text: 'Snapshot - Ticker', value: 'GET', type: 'success' },
        { text: 'Snapshot - Ticker Full Book (Level 2)', value: 'GET', type: 'success' },
        { text: 'Snapshot - Gainers/Losers', value: 'GET', type: 'success' },
      ]
    }
  }
      ...
      <div className='bg-stone-200/40 postSection'>
        <div className='relative overflow-hidden'>
          <div className='svg_background'>
            <object data="poly-hero-graphic.svg" type="image/svg+xml" width="1540" height="960"></object>
          </div>
          <div className='container slideTitle m-auto'>
            <p>
              <Badge value="New" severity="success" />
              <span className='introduce'> Introducing:</span>
              <span className='introduce_title'> Options Chain Snapshot API</span>
            </p>
            <h1>Market Data APIs</h1>
            <h2>Stocks, Options, Forex, and More</h2>
            <h3>Built by Developers for Developers</h3>
            <div>
              <Button label="Get your Free API Key" icon="pi pi-arrow-right" iconPos="right"  />
        ...
        <div>
          <div className='py-32'>
            <div className='container m-auto'>
              <h3 className='mb-10'>
                <center>Trusted by Top Companies, Governments, and Institutions.</center>
              </h3>
              <div className='other_site'>
                <div><img src='logo-google.svg' alt="google" style={{ height: '45px' }} /></div>
                <div><img src='logo-stanford.svg' alt="stanford" style={{ height: '26px' }} /></div>
                <div><img src='logo-public.svg' alt="public" style={{ height: '42px' }} /></div>
                <div><img src='logo-revolut.svg' alt="revolut" style={{ height: '31px' }} /></div>
                <div><img src='logo-motley-fool.svg' alt="motely" style={{ height: '65px' }} /></div>
                <div><img src='logo-sec.webp' alt="sec" style={{ height: '50px' }} /></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='bg-white financialCardList relative'>
        <div className='container m-auto mt-32 pt-32'>
          ...
          <div className='w-full py-28 grid tablet:grid-cols-1 laptop:grid-cols-2 desktop:grid-cols-4'>
            <div>
              <div className='py-4'>
                <h3 className='badgeText'>
                  { data.stockWebSockets.text }
                </h3>
                {
                  data.stockWebSockets.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
              <div className='py-4'>
                <h3 className='badgeText'>
                ...
                {
                  data.stockAPI.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
            </div>
            <div>
              <div className='py-4'>
                <h3 className='badgeText'>
                  { data.referenceDataAPI.text }
                </h3>
                {
                  data.referenceDataAPI.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
            </div>
            <div>
              <div className='py-4'>
                <h3 className='badgeText'>
                  { data.forexWebSockets.text }
                </h3>
                {
                  data.forexWebSockets.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
              <div className='py-4'>
                <h3 className='badgeText'>
                ...
                {
                  data.forexAPI.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
            </div>
            <div>
              <div className='py-4'>
                <h3 className='badgeText'>
                  { data.cryptoWebSockets.text }
                </h3>
                {
                  data.cryptoWebSockets.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
              <div className='py-4'>
                <h3 className='badgeText'>
                ...
                {
                  data.cryptoAPI.data.map((item, index) => <BadgeText text={item.text} type={item.type} value={item.value} />)
                }
              </div>
            </div>
          </div>
          ...
          <div className='w-full grid grid-cols-5 gap-32'>
            <div className='col-span-2'>
              ...
              <div className='mt-14 leading-7'>
                Create your application in any language. No more C++/Java limitations.
                Use the technology you already know, and spend your time creating, no integrating
              </div>
              <div className='mt-6'>
          ...
          <div className='col-span-6' >
            <div className='p-12 mt-6 reliable'>
              ...
              <div className='w-full grid grid-cols-2 gap-6 pt-12 pb-6'>
                ...
                <div>
                  <h2 className='text-xl font-bold text-white'>Equinix NY Data Centers</h2>
                  <p className='text-sm text-white'>Same data centers as the exchanges</p>
                </div>
                <div>
                  <h2 className='text-xl font-bold text-white'>Impeccable Reliability</h2>
          ...
          <div className='w-full grid grid-cols-3 gaps-10'>
            <div className='mb-2 flex flex-col justify-center'>
              ...
              <div className='mt-8 leading-7'>
                Polygon.io's market data APIs give you the tools you need to create visualizations for any platform or operating system,
                in the coding language which fits you best
              </div>
            </div>
            <div className='col-span-2'>
          ...
          <div className='grid grid-cols-3 gap-20 mt-10'>
            ...
            <div className='grid grid-rows-2 gap-4'>
              ...
              <div>
                ...
                <p className='text-base'>
                  The Motely Fool uses Polygon.io to power one of the largest financial and investing advice websites in the world.
                </p>
              </div>
            </div>
            <div className='grid grid-rows-2 gap-4'>
      ...
      <div className='bg-stone-200/40 py-32'>
        ...
        <div className='priceTab flex justify-center w-full'>
          <div className='flex justify-center items-center gap-10'>
            <SelectButton size={'small'} value={priceType} onChange={(e) => setPriceType(e.value)} itemTemplate={priceTypeTemplate} optionLabel='text' options={priceTypeOptions}/>
            <div className='flex items-center gap-1'>
              <span className='text-xs font-bold'>Monthly</span>
              <InputSwitch className='scale-90' checked={checked} onChange={(e) => setChecked(e.value)} />
              <span className='text-xs font-bold'>Annual</span>
            </div>
            <span style={{ fontSize: '10px', visibility: `${!priceType ? 'visible' : 'hidden'}` }}>
              20% Discount
            </span>
          </div>
        </div>
        <div className='container m-auto'>
          ...
          <div className='w-full flex justify-center mt-4'>
            <Button label="Compare Plans" severity="secondary" size="small" outlined />
          </div>
        </div>
        <div className='container m-auto'>
          <div className='mt-20'>
        ...
        <div className='container m-auto'>
          <div className='mt-20'>
            <h2 className='blacksubtitle text-center flex items-center justify-center gap-2'>
              <img src='currencies.svg' className='inline' /> <span>Curriences</span>
            </h2>
            <h3 className='text-sm text-center mb-8 mt-2'>
              Crypto + Forex
            </h3>
        ...
        <div className='container m-auto mt-32'>
          <div className='w-full flex justify-center flex-wrap gap-8'>
            <div><img src="cloud-chat-bubble.svg" alt="Not Sure" /></div>
            <div className='contact_us'>
              ...
              <p className='text-base mt-4'>
                We're always here to assist if you happen to need our help.
                Feel free to contact us and one of our team members will gladly walk
          ...
          <div className='w-full bg-white my-16 flex justify-center customer_section p-12'>
            <div className='flex flex-col flex-wrap item-stretch'>
              <h2 className='blacksubtitle text-center'>
                <span>We</span>
                <span className='px-4'><img className='inline' src='heart.svg' alt='heart' /></span>
                <span>Happy</span>
              </h2>
              <h2 className='blacksubtitle text-center'>
                Customers
              ...
              <p className='text-sm text-center leading-6'>
                Polygon is a dream come true when compared to some of the largest players in the market.
                They provide excellent quality data through a modern API with no long term contract.
              </p>
              <div className='mt-4 flex justify-center gap-4'>
                <div>
                  <img src="customer_profile_image.svg" alt="avatar" />
                </div>
                <div>
                  <p className='text-xl font-bold'>Dan Aisen</p>
                  <p className='text-base userEmail'>Founder@<span>Proof Trading</span></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='container m-auto grid grid-cols-12 gap-12 footer_top'>
          ...
          <div className='col-span-4 grid grid-rows-4 gap-6'>
            <div className='grid grid-cols-3'>
              <div>
                <img src="footer_item1.jpg" alt="" className='footer_item_img' />
              </div>
              <div className='col-span-2'>
                <p className='footer_item_date'>March 23, 2023</p>
                <h2 className='footer_item_title font-bold text-base'>Simplifying Data Access with CSV Support</h2>
                <p className='footer_item_text text-xs'>We are excited to announce the launch of CSV support for our REST APIs. You can now choose...</p>
              </div>
            </div>
            <div className='grid grid-cols-3'>
              <div>
                <img src="footer_item2.png" alt="" className='footer_item_img' />
              </div>
              <div className='col-span-2'>
                <p className='footer_item_date'>February 9, 2023</p>
                <h2 className='footer_item_title font-bold text-base'>Introducing Options Chain Snapshot API</h2>
                <p className='footer_item_text text-xs'>Level up your trading game by getting the mose up-to-date price data for an asset's entire options...</p>
              </div>
            </div>
            <div className='grid grid-cols-3'>
              <div>
                <img src="footer_item3.png" alt="" className='footer_item_img' />
              </div>
              <div className='col-span-2'>
                <p className='footer_item_date'>November 22, 2022</p>
                <h2 className='footer_item_title font-bold text-base'>Case Study: Birdwindgo</h2>
                <p className='footer_item_text text-xs'>Birdwindgo recently launched their mobile investment application, bringing an innovative twi...</p>
              </div>
            </div>
            <div className='grid grid-cols-3'>
              <div>
                <img src="footer_item4.png" alt="" className='footer_item_img' />
              </div>
              <div className='col-span-2'>
                <p className='footer_item_date'>September 6, 2022</p>
                <h2 className='footer_item_title font-bold text-base'>New Technical Indicators APIs</h2>
                <p className='footer_item_text text-xs'>After hundreds of requests from our community, we're happy to announce the release of out new...</p>
              </div>
            </div>
          </div>
        </div>
