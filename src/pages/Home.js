        ...
        <div className="container m-auto flex flex-col gap-10">
          ...
          <div className="w-full grid grid-cols-3 gap-8">
            <SimpleCard
              ...
              icon={
                <svg
                  class="svg-inline--fa fa-polygon"
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fak"
                  data-icon="polygon"
          ...
          <div className="w-full grid grid-cols-3 gaps-10">
            <div className="mb-2 flex flex-col justify-center">
              ...
              <div className="mt-8 leading-7">
                Polygon.io's market data APIs give you the tools you need to
          ...
          <div className="grid grid-cols-3 gap-20 mt-10">
            <div className="grid grid-rows-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base">
                  Polygon.io has teamed up with Google to provide BigQuery
            ...
            <div className="grid grid-rows-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base">
                  The Motely Fool uses Polygon.io to power one of the largest
            ...
            <div className="grid grid-rows-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base">
                  Revolut trusts Polygon.io to power their new trading
          ...
          <div className="w-full bg-white my-16 flex justify-center customer_section p-12">
            <div className="flex flex-col flex-wrap item-stretch">
              ...
              <p className="text-sm text-center leading-6">
                Polygon is a dream come true when compared to some of the
              ...
              <div className="mt-4 flex justify-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-base userEmail">
                    Founder@<span>Proof Trading</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container m-auto grid grid-cols-12 gap-12">
          ...
          <div className="col-span-5">
            <p className="footer_item_text text-xs">
              ...
              purposes. Polygon provides all information as is. You must not
